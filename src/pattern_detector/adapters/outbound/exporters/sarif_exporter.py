...
class SarifExporter(ExporterPort):
    def export(self, report: DetectionReport, output_path: str) -> None:
        ...
        for d in report.detections:
            rule_id = f"DPX-DART-{d.pattern_type.value.upper()}"
            ...
            results.append({
                ...
                "level": "error" if d.category.value == "dart_flutter_security_hazards" else "note",
            ...
            "runs": [
                {
                    "tool": {
                        "driver": {
                            "name": "DPX-Dart",
                            "version": "0.1.0",
                            "informationUri": "https://github.com/bivex/DPX-Dart",
                            "rules": rules,
                        }
                    },
                    "results": results,
